...
public class MatchVO {
	...
	public String toString() {
		return "MatchVO [matchId=" + matchId + ", league=" + league + ", description=" + description + ", matchMonth="
				+ matchMonth + ", matchTime=" + matchTime + ", homeTeam=" + homeTeam + ", awayTeam=" + awayTeam
				+ ", homeRatio=" + homeRatio + ", drawRatio=" + drawRatio + ", awawyRatio=" + awawyRatio + ", score="
				+ score + ", result=" + result + ", status=" + status + "]";
	}
